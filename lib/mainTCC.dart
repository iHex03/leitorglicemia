//Glicoreader
//Código criado por Marcel Fernandes de Mattos
//Contato: dev.mmattos@gmail.com
//Repositório do Projeto: https://github.com/iHex03/leitorglicemia
  ...
  final response = await http.post(url,
      ...
      body: json.encode({
        ...
        'template_params': {
          ...
          'user_email': '', //INSERIR EMAIL ATRIBUIDO AO REMETENTE AQUI
...
String emailEmergencia = ''; //INSERIR EMAIL ATRIBUIDO AO DESTINATÁRIO AQUI
